        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28 relative z-10">
          <div className="max-w-xl lg:max-w-2xl">
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-bold tracking-[0.2em] text-[#caa359] uppercase">
                OUR BLOG
              </span>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-none mb-4 uppercase">
              Insights for a <br />
              <span className="text-[#caa359]">Better Tomorrow</span>
            </h1>
            ...
            <div className="mt-8 max-w-md">
              <div className="relative flex items-center bg-white rounded-xl border border-gray-300 shadow-sm p-1.5 focus-within:border-[#caa359] focus-within:ring-2 focus-within:ring-[#caa359]/20 transition-all">
                ...
                <button
                  type="button"
                  className="w-10 h-10 rounded-lg bg-[#caa359] hover:bg-[#b58f4a] text-white flex items-center justify-center shrink-0 transition-all shadow-sm cursor-pointer"
                  title="Search"
                >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-none text-xs sm:text-sm font-semibold transition-all shrink-0 cursor-pointer ${
                  activeCategory.toLowerCase() === cat.toLowerCase()
                    ? 'bg-[#caa359] text-white shadow-md shadow-[#caa359]/20'
        ...
        <div className="mt-10">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-24">
              <Loader2 className="w-10 h-10 text-[#caa359] animate-spin mb-4" />
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 p-8 max-w-xl mx-auto">
              <BookOpen className="w-12 h-12 text-[#caa359] mx-auto mb-3 opacity-60" />
              ...
              {(searchQuery || activeCategory !== 'All') && (
                <button
                  ...
                  className="px-5 py-2.5 bg-[#caa359] text-white rounded-none text-xs font-semibold hover:bg-[#b58f4a] transition-all cursor-pointer"
                >
                  Reset Filters
                </button>
              )}
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between gap-2 mb-3.5">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-xs font-bold bg-amber-50 text-[#caa359] border border-[#caa359]/30">
                    ...
                    <Link to={`/blog/${blog.slug}`} className="block">
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-[#caa359] transition-colors line-clamp-2 leading-snug mb-3">
                        {blog.title}
                      </h3>
                    </Link>
                    ...
                    <div className="pt-4 border-t border-gray-100 flex items-center justify-between mt-auto">
                      <Link
                        to={`/blog/${blog.slug}`}
                        className="inline-flex items-center gap-1.5 text-xs font-bold text-[#caa359] group-hover:text-[#b58f4a] group-hover:gap-2 transition-all cursor-pointer"
                      >
